...
def getShowList():
    ...
    url = "https://show.maoyan.com/maoyansh/myshow/ajax/v2/performance/" + showId + "/shows/0?performanceId=" + showId + "&optimus_risk_level=" + optimus_risk_level + "&optimus_code=" + optimus_code + "&uuid=" + uuid + "&sellChannel=" + sellChannel + "&cityId=" + cityId + "&token=" + token + "&yodaReady=h5&csecplatform=" + csecplatform + "&csecversion=2.4.0"
...
def getShowTicketsList():
    ...
    url = "https://show.maoyan.com/maoyansh/myshow/ajax/v2/show/" + str(showData['showId']) + "/tickets?performanceId=" + showId + "&optimus_risk_level=" + optimus_risk_level + "&optimus_code=" + optimus_code + "&uuid=" + uuid + "&sellChannel=" + sellChannel + "&cityId=" + cityId + "&token=" + token + "&yodaReady=h5&csecplatform=" + csecplatform + "&csecversion=2.4.0"
    response = requests.get(url, headers=HEADERS)
    # print(response.json())
    return response.json()['data']
...
def createOrder():
    ...
    url = "https://show.maoyan.com/maoyansh/myshow/ajax/order?optimus_risk_level=" + optimus_risk_level + "&optimus_code=" + optimus_code + "&uuid=" + uuid + "&sellChannel=" + sellChannel + "&cityId=" + cityId + "&token=" + token + "&yodaReady=h5&csecplatform=" + csecplatform + "&csecversion=2.4.0"
